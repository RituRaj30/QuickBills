...
import { FaX, FaDownload, FaQrcode } from 'react-icons/fa6'
...
const InvoiceReview = () => {
    ...
    return (
        <div className='relative'>
            <button onClick={() => setShowReview((prev) => !prev)} className='fixed z-[1000] top-6 right-6 text-white'><FaX size={28} /></button>
                ...
                <div className='overflow-y-auto flex justify-center my-6 pr-1 rounded-lg'>
                    <div id="invoice" className="p-8 text-black bg-white w-[48rem] h-fit rounded-lg">
                        <div className="flex items-center justify-between">
                            ...
                            {/* ADDING QR */}
                            {/* <div>
                                <QRCode value={pdfUrl} size={100} level="H" />
                            </div> */}
