...
import { FaDownload, FaQrcode, FaTrash } from 'react-icons/fa6';
...
const ControlCentre = () => {
    ...
    return (
        <div className="flex w-full flex-col items-center justify-center gap-4 pb-5">
            ...
            {/* <div className=" flex w-full justify-between">
                <button onClick={() => setShowReview(prev => !prev)} className="btn w-full btn-info bg-cyan-300">
            ...
            <div className="form-control w-full max-w-xs -mt-2">
                <label className="label">
                    <span className="label-text text-gray-400">Currency</span>
                </label>
            ...
            <div className="form-control w-full max-w-xs -mt-2">
                <label className="label">
                    <span className="label-text text-gray-400">Date Format</span>
                </label>
            ...
            <div className="flex flex-col w-full">
                <div className="form-control">
                    <label className="cursor-pointer label">
                        <span className="label-text text-gray-400">Payments Terms</span>
                        <input
                            onChange={(e) => {
                ...
                <div className="form-control">
                    <label className="cursor-pointer label">
                        <span className="label-text text-gray-400">Client Notes</span>
                        <input
                            onChange={(e) => {
