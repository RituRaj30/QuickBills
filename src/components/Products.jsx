...
const Products = () => {
    ...
    return (
        <div>
            ...
            <div className='text-lg font-semibold py-5 pb-2 text-gray-400'>New Item</div>
    ...
    return (
        <div className='w-full flex lg:flex-nowrap flex-wrap gap-5 gap-y-0'>
            <div className=" flex-1 min-w-[10rem]">
                ...
                <input id="name" onChange={handleChange} value={product.name} type="text" placeholder="Name"
                className="input input-bordered w-full h-10" />
                <textarea id="description" onChange={handleChange} value={product.description} className="textarea textarea-bordered w-full mt-3 text-black" placeholder="Description"></textarea>
            </div>

            <div className="">
                <label className="label">
                    <span className="label-text text-gray-400">Qty</span>
                </label>
                <input id="quantity" onChange={handleChange} value={product.quantity} type="number" placeholder="0"
                    min={1}
                    className="input input-bordered w-[5rem] h-10 text-black" />
            </div>
            ...
            <div>
                <label className="label">
                    <span className="label-text text-gray-400">Sub Total</span>
                </label>
            ...
            <div>
                <label className="label">
                    <span className="label-text text-gray-400">Action</span>
                </label>
