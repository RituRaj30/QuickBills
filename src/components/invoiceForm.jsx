            ...
            <div className='bg-gray-900 lg:p-10 md:p-7 p-5 rounded-lg lg:min-w-[40rem] lg:w-[50rem] md:w-[45rem] w-[95%]'>
                <div className='flex lg:flex-row flex-col lg:items-center items-start gap-3 justify-between pb-2'>
                    <div className='flex gap-2 items-center'>
                        <h3 className=' font-semibold text-lg text-gray-300'>Current Date : </h3>
                        <p className='text-gray-400'>{new Date().toDateString()}</p>
                    </div>

                    <div className='flex gap-2 items-center'>
                        <h3 className=' font-semibold text-lg text-gray-300'>Invoice # </h3>
                ...
                <div className="w-full max-w-xs flex items-center gap-2">
                    <label className="label">
                        <span className=" font-semibold text-lg text-gray-300">Billing Date :</span>
                    </label>
                ...
                <div className="divider pt-8 pb-2 text-gray-300">Store Info</div>
                ...
                <div className="divider py-2 text-gray-300">Buyer Info</div>
                ...
                <div className='flex lg:flex-row flex-col gap-2 items-center justify-between'>
                    ...
                    <div>
                        ...
                        <div className="form-control w-full max-w-xs">
                            <label className="label">
                                <span className="text-gray-400">Mob No.</span>
                            </label>
                ...
                <div className="divider pt-8 pb-2 text-gray-300">Products</div>
                <Products />
